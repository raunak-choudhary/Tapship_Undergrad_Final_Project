                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        ...
                                        <div class="text-uppercase text-primary font-weight-bold text-xs mb-1" style="width: 300px;"><span class="text-capitalize text-center" style="font-size: 25px;color: rgb(1,5,15);">&nbsp; &nbsp; Total Available Crops :
                                                <?php
                                                echo $CropTotalCount = $con->query("SELECT * FROM cropsale CS where cs.cr_status IN (0,1) AND (SELECT count(cb_id) from cropbid cb, customer c, cropsale cs WHERE c.c_mobile=cb.cb_c_mobile AND cb.cb_cr_id = cs.cr_id and c.c_mobile=$c_mobile)=0")->num_rows;
                                                ?>
                                                &nbsp;</span>
                                        </div>
