...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/table-style-findcrop.css"/>
</head>
...
?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: 'findcrop-pin-widget-back.php',
                method: "POST",
                data: "c_mobile=" + <?php echo $c_mobile; ?> + "&c_pincode=" + <?php echo $c_pincode; ?>,
