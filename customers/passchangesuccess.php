...
while ($res = mysqli_fetch_assoc($result)) {
    $c_temppass =  $res['c_temppass'];
}

$query = "update customer set c_password = '$c_temppass', c_temppass='' where c_mobile = $c_mobile";
echo $query;
...
<body>
    ...
    <div class="container" style="margin-top:150px;">
        <div class="jumbotron" style="text-align: center; background-color:#0c3823; color:#fff;">
            ...
            <h5>Try to login with new password for next time.</h5>
            <br>
