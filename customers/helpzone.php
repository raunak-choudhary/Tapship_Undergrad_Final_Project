...
<head>
    ...
    <title>Customer Help Zone</title>
            ...
            <div class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
                ...
                <div class="flex flex-col justify-between">
                    <div class="mt-2">
                        ...
                        <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" id="customer_subject" name="customer_subject" placeholder="Enter Subject of your Issue" required="" autofocus="">
                    </div>
                    <div class="mt-2">
                        <span class="uppercase text-sm text-gray-600 font-bold">Message</span>
                        <textarea class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" id="customer_message" name="customer_message" title="Enter your Issue in Detail" placeholder="Enter your Issue" required="" autofocus=""></textarea>
                    </div>
                    <div class="mt-2">
