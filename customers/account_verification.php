...
<body id="page-top">
    ...
    $c_av_otp=$res['c_av_otp'];
    $c_av_status=$res['c_av_status'];

    if($c_av_status=="ACTIVE"){
    ...
    {   
        if($c_av_otp=='')
        {
            ...
            $client->messages->create(
                ...
                array(
                    'from' => $twilio_number,
                    'body' => '[Tapship: Account Verification] Hello '.$res['c_name'].", You have been registered as customer on Tapship.Please enter this OTP to verify your account ".$GeneratedOTP.". Do not share it with anyone"
                )
            );

            $InsertOTP=$con->query("UPDATE customer SET c_av_otp='".$GeneratedOTP."' WHERE c_mobile='".$c_mobile."'");
        }
...
<div class="features-boxed">
        ...
        <div class="d-flex justify-content-center align-items-center">
            <div class="position-relative p-5">
                ...
                if(isset($_POST['submit'])){
                    ...
                    $res['c_tsv_otp'];
                    if($res['c_av_otp']==$EnteredOTP){
                        $TsvValidity=time()+86400;
                        $UpdateStatus=$con->query("UPDATE customer SET c_av_otp='', c_av_status='ACTIVE', c_tsv_validity='".$TsvValidity."' WHERE c_mobile='".$c_mobile."'");
    ...
    function resendOTP(uid){
        ...
        $.ajax({
            url: "resend-otp.php",
            method: "POST",
            data: "uid="+uid+"&name=<?php echo $res['c_name'];?>&type=av",
