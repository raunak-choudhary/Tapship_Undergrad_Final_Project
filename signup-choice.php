        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" data-bs-hover-animate="pulse" href="../about.php">CONTACT</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" data-bs-hover-animate="pulse" href="../faq.php">CONTACT</a></li>
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a href="signup.php"><button class="btn btn-dark text-monospace" data-bs-hover-animate="pulse" type="button" style="margin: 10px;background: rgb(255,255,255);color: #0c3823;margin-left: 0;border-radius: 10px;">Sign Up</button></a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="article-list" style="background: rgb(252,252,252);">
        <div class="container">
            ...
            <div class="row articles" style="margin: 5px;">
                ...
                <div class="col-sm-6 col-md-4 item" style="background: #0c3823;min-height: auto;max-height: auto;text-align: center;"><a href="drivers/signup.php"><img class="img-fluid" data-bs-hover-animate="pulse" src="assets/img/drivers.png" style="filter: invert(100%);"><h3 class="name" style="font-size: 24px;color: rgb(255,255,255);">New Drivers</h3></a>
                </div>
            </div>
        </div>
    </div>
