  ...
  <div class="features-boxed">
    <div class="container-fluid" style="background: #ffffff;">
      <div class="intro" style="background: #0c3823;margin-top: 120px;margin-bottom: 30px; max-width:1000px;">
        <h2 class="text-center" data-aos="fade" style="color: rgb(255,255,255);padding: 30px;margin-bottom: 0px;">FAQs</h2>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div>
        ...
        <div class="answers">
          ...
          <p>By mail, please submit your order form (from a catalog, brochure, or PDF) or purchase order to:</p>
          <p>
            Cavendish Square<br />
          ...
          <p>Please feel free to order toll-free via telephone between 9 AM and 5 PM, Eastern Standard Time, Monday through Friday at 1-877-980-4450.</p>
          <p>To order online, please select items for your cart and proceed to Checkout, or you can input ISBNs directly to create a quick order here.</p>
        </div>
      </div>
      <!-- _____________________________________________________ -->
      <div>
        ...
        <div class="answers">
          ...
          <p>When placing your online order please follow instructions for coupon and bonus redemption. For any price-reduction offers and special discounts, please include these details within the comment section of the purchase portal.</p>
          <p>You can also contact Customer Service at 1-877-980-4450 between 9 AM and 5 PM, EST, Monday through Friday to redeem offers.</p>
        </div>
      </div>
      <!-- _____________________________________________________ -->
      <div>
      ...
      <div>
        ...
        <div class="answers">
          ...
          <p>You can verify usage rights through Customer Service at 1-877-980-4450 or by submitting your query through our Customer Service form.</p>
          <p>When contacting us, please have the book title/product name and ISBN that you’re inquiring about, along with a description of how you would like to use/reproduce the materials.</p>
          <p>
