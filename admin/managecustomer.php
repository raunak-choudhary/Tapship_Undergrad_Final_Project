...
<body id="page-top">
    ...
    <table id="tabledata" class=" table table-striped table-hover table-bordered">
        ...
        $q = "select c_id, c_name, c_mobile, c_city, c_type, c_approve, c_photo from customer where c_id!=0 ORDER BY c_id DESC";
        ...
        ?>
            <tr class="text-center">
                ...
                <td data-label="Status"> <?php if ($res['c_approve'] == "1") {
                                                echo "No Action";
                                            } else if ($res['c_approve'] == "2") {
                                                echo " Accepted";
                                            } else if ($res['c_approve'] == "3") {
                                                echo "Review";
                                            } else if ($res['c_approve'] == "4") {
                                                echo "Rejected";
                                            } else if ($res['c_approve'] == "5") {
                                                echo "Resubmitted";
                                            }  ?> </td>
