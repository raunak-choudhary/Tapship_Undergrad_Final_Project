    ...
    <div class="article-list" style="background: rgb(252,252,252);">
        <div class="container">
            ...
            <div class="row articles" style="margin: 5px;">
                <div class="col-sm-6 col-md-4 item" style="background: #0c3823;height: auto;min-height: auto;max-height: auto;font-size: 20px;"><a href="farmers/login.php"><img class="img-fluid" data-bs-hover-animate="pulse" src="assets/img/farmer.png" style="text-align: center;filter: invert(100%);"><h3 class="name" style="color: rgb(255,255,255);font-size: 24px;">Farmers</h3></a>
                </div>
