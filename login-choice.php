        ...
        <div class="container">
            <div class="intro">
                <div style="background: #0c3823;margin-top: 20px;margin-bottom: -10px;">
                    <h2 class="text-center" style="background: rgba(12,56,35,0);color: rgb(255,255,255);padding: 15px;margin-bottom: 0px;">Already Have Account?</h2>
            ...
            <div class="row articles" style="margin: 5px;">
                <div class="col-sm-6 col-md-4 item" style="background: #0c3823;height: auto;min-height: auto;max-height: auto;font-size: 20px;"><a href="farmers/login.php"><img class="img-fluid" data-bs-hover-animate="pulse" src="assets/img/farmer.png" style="text-align: center;filter: invert(100%);">
                        <h3 class="name" style="color: rgb(255,255,255);font-size: 24px;">Farmers</h3>
                    </a>
                </div>
                <div class="col-sm-6 col-md-4 item" style="background: #115434;min-height: auto;max-height: auto;"><a href="customers/login.php"><img class="img-fluid" data-bs-hover-animate="pulse" src="assets/img/customer.png" style="filter: invert(100%);">
                        <h3 class="name" style="font-size: 24px;color: rgb(255,255,255);">Customers</h3>
                    </a>
                </div>
                <div class="col-sm-6 col-md-4 item" style="background: #0c3823;min-height: auto;max-height: auto;text-align: center;"><a href="drivers/login.php"><img class="img-fluid" data-bs-hover-animate="pulse" src="assets/img/drivers.png" style="filter: invert(100%);">
                        <h3 class="name" style="font-size: 24px;color: rgb(255,255,255);">Drivers</h3>
                    </a>
                </div>
            </div>
        </div>
