            ...
            <div class="position-relative">
                ...
                if(isset($_POST['submit'])){
                    ...
                    if($res['f_tsv_otp']==$EnteredOTP){
                        ...
                        echo '<div class="alert alert-success w-100">Verification successful. redirecting to home...</div><script>setTimeout(function(){ location.replace("passchangesuccess.php?mob='.$f_mobile.'"); }, 1000)</script>';
                    }
                    else{
