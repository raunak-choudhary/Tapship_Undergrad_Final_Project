        ...
        <form action="helpzone-script.php" method="post">
            <div class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
                <div class="flex flex-col justify-center">
                    ...
                    <div class="mt-8 text-center" style="border: 1px solid black;">
                ...
                <div class="flex flex-col justify-between">
                    <div class="mt-8">
                        ...
                        <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" id="farmer_name" name="farmer_name" placeholder="Enter your Full Name" value="<?php echo $f_name; ?>" required="" autofocus="" disabled>
                    </div>
                    <div class="mt-8">
                        <span class="uppercase text-sm text-gray-600 font-bold">Mobile Number</span>
                        <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="phone" id="farmer_mobile" name="farmer_mobile" pattern="^[6-9]{1}[0-9]{9}$" title="Enter Valid 10 digit Mobile Number (Ex. 76435654XX)" placeholder="Enter your Mobile Number" value="<?php echo $f_mobile; ?>" required="" autofocus="" disabled>
                    </div>
                    <div class="mt-8">
