...
<body id="page-top">
    ...
    <div class="features-boxed">
        <div class="container-fluid" style="background: #ffffff;">
            <div class="intro" style="background: #0c3823;margin-top: 120px;margin-bottom: 30px;">
                <h2 class="text-center" data-aos="fade" style="color: rgb(255,255,255);padding: 30px;margin-bottom: 0px;">MEP Trend</h2>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: 'viewmeptrend-widget-back.php',
                method: "POST",
                data: "id=" + <?php echo $id; ?> ,
