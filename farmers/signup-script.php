...
if (isset($_POST["submit"]))
 {
    ...
    $query = "INSERT into farmer(farmer_mobile,farmer_name,farmer_gender,farmer_age,farmer_street,farmer_city,farmer_state,farmer_pincode,farmer_aadhar,farmer_aadharpdf,farmer_pan,farmer_panpdf,farmer_photo,farmer_password,farmer_access) VALUES('$farmer_mobile','$farmer_name','$farmer_gender','$farmer_age','$farmer_street','$farmer_city','$farmer_state','$farmer_pincode','$farmer_aadhar','$target_path1','$farmer_pan','$target_path2','$target_path3','$farmer_password','$farmer_access',)";
