...
$query = "SELECT cb.cb_id FROM cropsale cs, farmer f, customer c, cropbid cb where f.f_mobile=cs.cr_f_mobile AND c.c_mobile=cb.cb_c_mobile AND cb.cb_cr_id=cs.cr_id AND cs.cr_id=$cr_id";
