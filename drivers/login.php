...
<body id="page-top">
    ...
    <div class="login-clean" style="padding: 0px;background: rgb(255,255,255);margin-top: 30px;">
        <form method="post" style="background: #0c3823;margin-bottom: 40px;">
            ...
            <div class="form-group"><input class="form-control" type="phone" name="d_mobile" placeholder="Mobile Number"></div>
            <div class="form-group"><input class="form-control" type="password" name="d_password" placeholder="Password"></div>
