   ...
   if($_SESSION['otptimer']>time()){
        ...
        $GeneratedOTP=rand(100000, 999999);
                ...
                $client->messages->create(
                    ...
                    array(
                        'from' => $twilio_number,
                        'body' => '[Tapship: Account Verification] Hello '.$name.", You have been registered as driver on Tapship.Please enter this OTP to verify your account ".$GeneratedOTP.". Do not share it with anyone"
                    )
                );
                $con = mysqli_connect("localhost", "root", "", "tapship");
                $InsertOTP=$con->query("UPDATE driver SET d_av_otp='".$GeneratedOTP."' WHERE d_mobile='".$uid."'");
